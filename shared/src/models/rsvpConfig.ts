...
// Selected template for RSVP messaging
export interface SelectedTemplate {
  templateFireBaseId: string; // Firebase document ID of the template
  templateSid: string; // Twilio template SID
  isGlobal: boolean; // Whether this is a global template or wedding-specific
}
