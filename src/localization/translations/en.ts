...
export const englishTranslations: Translations = {
  ...
  tasks: {
    ...
    bulkComplete: {
      ...
      message: "Mark {{count}} tasks as complete?",
      confirm: "Complete Tasks",
    },
    bulkDelete: {
      button: "Delete",
      title: "Delete Tasks",
      message: "Delete {{count}} tasks? This cannot be undone.",
  ...
  leads: {
    ...
    stats: {
      ...
      expectedIncomeTooltip: "Remaining balance = Quotation - Paid So Far",
      sourceDistribution: "Lead Sources",
    },
    activityPanel: {
      title: "Activity",
