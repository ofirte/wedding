...
export const hebrewTranslations: Translations = {
  ...
  rsvp: {
    ...
    welcome: {
      ...
      step2Description:
        "הגדירו מתי לשלוח הזמנות, תזכורות והודעות תודה לאורחים באופן אוטומטי.",
    ...
    premiumPricing: {
      ...
      howItWorks: {
        ...
        step3: {
          ...
          description: "אנחנו מטפלים בתזכורות, פרטי האירוע והודעות תודה",
          icon: "automation",
        },
      },
      features: {
      ...
      cta: {
        ...
        upgradeButton: "שדרג לאישור הגעה פרימיום",
