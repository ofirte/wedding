...
const AutomationInfoDialog: React.FC<AutomationInfoDialogProps> = ({
  ...
  const successfulMessages =
    automation.completionStats?.successfulMessages || 0;
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body1">{automation.name}</Typography>
                  </Box>
                  <Box>
                    <Typography variant="body2" color="text.secondary">
              ...
              {automation.completionStats?.completedAt && (
                <Box sx={{ mt: 2 }}>
                  <Typography variant="body2" color="text.secondary">
                    {t("rsvp.completedAt")}:{" "}
                    {format(
                      new Date(automation.completionStats.completedAt),
                      "PPp"
                    )}
                  </Typography>
                </Box>
